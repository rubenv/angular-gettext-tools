...
var noDelimRegex = mkAttrRegex('', '', false);
...
var Extractor = (function () {
    function Extractor(options) {
        ...
        this.strings = {};
        this.attrRegex = mkAttrRegex(this.options.startDelim, this.options.endDelim, this.options.bindOnce);
    }
