...
var Extractor = (function () {
    ...
    Extractor.prototype.extractJs = function (filename, src) {
        ...
        function isGetInterpolatedString(node) {
            return node !== null &&
                node.type === 'CallExpression' &&
                node.callee !== null &&
                node.callee.type === 'MemberExpression' &&
                ...
                node.callee.object.name === 'gettextCatalog' &&
                node.callee.property !== null &&
                node.callee.property.name === 'getInterpolatedString' &&
                node.arguments !== null &&
                node.arguments.length;
        }
        ...
        function isGetInterpolatedPlural(node) {
            return node !== null &&
                node.type === 'CallExpression' &&
                node.callee !== null &&
                node.callee.type === 'MemberExpression' &&
                ...
                node.callee.object.name === 'gettextCatalog' &&
                node.callee.property !== null &&
                node.callee.property.name === 'getInterpolatedPlural' &&
                node.arguments !== null &&
                node.arguments.length;
        }
        ...
        walkJs(syntax, function (node, parentComment) {
            ...
            if (isGettext(node) || isGetString(node) || isGetInterpolatedString(node)) {
                str = getJSExpression(node.arguments[0]);
            } else if (isGetPlural(node) || isGetInterpolatedPlural(node)) {
